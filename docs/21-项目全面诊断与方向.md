...
| P1 | `GroupBuyExpiryScheduler` 锁 + BirthdayConfigController VO | 试点资金安全与接口契约；`CustomerPortalController.pay` 和审计日志敏感字段脱敏已修复 |
...
| code-hotfixes | 部分完成：CustomerPortalController.pay 事务/流水 rows、审计日志敏感字段脱敏已修复；剩余 GroupBuyExpiryScheduler 锁、BirthdayConfigController VO | P1 |
