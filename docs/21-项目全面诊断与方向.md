...
| P1 | `GroupBuyExpiryScheduler` 锁 | 试点资金安全与接口契约；`CustomerPortalController.pay`、审计日志敏感字段脱敏、BirthdayConfigController VO 已修复 |
...
| code-hotfixes | 部分完成：CustomerPortalController.pay 事务/流水 rows、审计日志敏感字段脱敏、BirthdayConfigController VO 已修复；剩余 GroupBuyExpiryScheduler 锁 | P1 |
